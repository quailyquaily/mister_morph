...
func DefaultPromptSpec() PromptSpec {
	return PromptSpec{
		...
		Rules: []string{
			...
			"If the user asks to update your long-term persona/tone, update file_state_dir/IDENTITY.md and/or file_state_dir/SOUL.md using write_file.",
			"When calling contacts_send for dialogue topics (share.proactive.v1, dm.checkin.v1, dm.reply.v1, chat.message), you MUST provide session_id as a UUIDv7 string.",
