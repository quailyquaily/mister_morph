...
const I18N = {
  ...
  zh: {
    ...
    setup_hint_single_ready: "Endpoint \"{name}\" 已就绪，可直接进入 Chat。",
    setup_hint_multi_ready: "存在多个可用 endpoint，请在下方选择后继续。",
    setup_action_enter_chat: "进入 Chat",
    group_basic: "基础状态",
    group_model: "模型配置",
    group_channels: "接入渠道",
    group_runtime: "运行时指标",
  ...
  ja: {
    ...
    setup_hint_single_ready: "Endpoint \"{name}\" は利用可能です。Chat に直接入れます。",
    setup_hint_multi_ready: "利用可能な endpoint が複数あります。下で選択して続行してください。",
    setup_action_enter_chat: "Chat に入る",
    group_basic: "基本状態",
    group_model: "モデル設定",
